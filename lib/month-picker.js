...
var MonthPicker = function (_Component) {
    ...
    _createClass(MonthPicker, [{
        ...
        value: function optionPad(padIndex) {
            ...
            console.log('--- %s ----', rawValue.type, { padIndex: padIndex, labelYear: labelYear, otherValue: otherValue });
                    ...
                    mapToArray(12, function (i) {
                        ...
                        if (atMinYear && m < ymArr[0].min) {
                            ...
                            for (var _i = valOffset, last = values.length - 1; _i <= last; _i++) {
                                ...
                                if (v === m) {
                                    valOffset++;
                                    if (!isRange || _from.year === labelYear && _i === 0 || _to.year === labelYear && _i === last) {
                                        css = 'active';
        ...
        value: function setYear(idx, step) {
            ...
            this.setState({ labelYears: labelYears });
